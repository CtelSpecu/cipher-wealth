...
/**
 * Hook that ensures the Sepolia RPC is healthy. If the wallet's current RPC
 * appears unhealthy, it will probe a list of public RPCs and attempt to
 * add/switch the network in MetaMask to a working one.
 */
